...
public class BaseTest implements AppiumDriverProvider {
	...
	public void beforeTest(String apiKey, String appID, String deviceID)
		...
		capabilities.setCapability(TestObjectCapabilities.TESTOBJECT_SUITE_NAME, "CHETAN_APP_TEST");
		capabilities.setCapability(TestObjectCapabilities.TESTOBJECT_TEST_NAME, "CHETAN_SHOPPING_TEST");
